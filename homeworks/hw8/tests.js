...
export function generateTests(CONFIG) {
    ...
    CONFIG.isStep(steps.jk) && describe('😬', () => {
        ...
        სემინარებზე შეიძლება გავიაროთ მაინც. დამატებით, მიმაჩნია, რომ ეს დავალება ბევრად უფრო
    ...
    CONFIG.isStep(steps.introduction) && describe('შესავალი', () => {
        ...
        საკუთარ javascript ფაილში (tree.js) ორი ფუნქციაა აუცილებელი. მთავარი არის ფუნქცია, რომელსაც უნდა ერქვას makeChristmasTree. ახლა ხედავ, რომ 
